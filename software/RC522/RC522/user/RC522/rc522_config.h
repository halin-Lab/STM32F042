...
/*********************************** RC522 引脚定义 *********************************************/
#define               macRC522_GPIO_CS_CLK_FUN                  RCC_AHBPeriphClockCmd
#define               macRC522_GPIO_CS_CLK                      RCC_AHBPeriph_GPIOA
#define               macRC522_GPIO_CS_PORT    	                GPIOA			   
#define               macRC522_GPIO_CS_PIN		                  GPIO_Pin_4
#define               macRC522_GPIO_CS_Mode		                  GPIO_Mode_OUT

#define               macRC522_GPIO_SCK_CLK_FUN                 RCC_AHBPeriphClockCmd
#define               macRC522_GPIO_SCK_CLK                     RCC_AHBPeriph_GPIOA
#define               macRC522_GPIO_SCK_PORT    	              GPIOA			   
#define               macRC522_GPIO_SCK_PIN		                  GPIO_Pin_5
#define               macRC522_GPIO_SCK_Mode		                GPIO_Mode_OUT

#define               macRC522_GPIO_MOSI_CLK_FUN                RCC_AHBPeriphClockCmd
#define               macRC522_GPIO_MOSI_CLK                    RCC_AHBPeriph_GPIOA
#define               macRC522_GPIO_MOSI_PORT    	              GPIOA			   
#define               macRC522_GPIO_MOSI_PIN		                GPIO_Pin_7
#define               macRC522_GPIO_MOSI_Mode		                GPIO_Mode_OUT

#define               macRC522_GPIO_MISO_CLK_FUN                RCC_AHBPeriphClockCmd
#define               macRC522_GPIO_MISO_CLK                    RCC_AHBPeriph_GPIOA
#define               macRC522_GPIO_MISO_PORT    	              GPIOA			   
#define               macRC522_GPIO_MISO_PIN		                GPIO_Pin_6
#define               macRC522_GPIO_MISO_Mode		                GPIO_Mode_IN

#define               macRC522_GPIO_RST_CLK_FUN                 RCC_AHBPeriphClockCmd
#define               macRC522_GPIO_RST_CLK                     RCC_AHBPeriph_GPIOA
#define               macRC522_GPIO_RST_PORT    	              GPIOA		   
#define               macRC522_GPIO_RST_PIN		                  GPIO_Pin_3
#define               macRC522_GPIO_RST_Mode		                GPIO_Mode_OUT
